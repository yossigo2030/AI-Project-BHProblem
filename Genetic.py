...
#
#     def best_neural(self):
#         max_score = 0
#         index = 0
#         for i in range(len(self.score_array)):
#             if self.score_array[i] > max_score:
#                 max_score = self.score_array[i]
#                 index = i
#         return index, max_score
#
#     def choose_action(self, array):
#         shot = False
#         dir = np.array([0, 0])
#         max_num = 0
#         action = 0
...
#         return dir, shot
#
#     def genetic_algorithm(self, num_of_gen, num_of_net_in_gen):
#         generation = 0
#         numm = 0
#         final_game = False
...
#             if len(self.brain_array) == 0:
#                 for i in range(num_of_net_in_gen):
#                     neural_network_array.append(create_neural_network())
#             elif not final_game:
#                 neural_network = NeuralNetwork(self.brain_array, self.score_array)
#                 neural_network_array = neural_network.get_new_neural_network()
#             else:
#                 neural_network_array = self.brain_array
#             self.q_genetic(neural_network_array, num_of_net_in_gen, final_game)
#             generation += 1
#             # numm = save(numm)
#
#     # def save(num):
...
#     #     return numm + 1
#
#     def q_genetic(self, brains, num_of_net_in_gen, final_game):
#         brains_array = brains
#         # global brain_array
#         # global score_array
#         self.brain_array = []
...
#                     move = self.choose_action(output_array)
#                 game.update(move)
#                 clock.tick(tps)
#                 if game.get_lives() == 0:
...
#                 break
#
#     def read_neural_network(self, matrix_1, metrix_2, metrix_3):
#         network = []
...
#         return network
#
#     def read_genetic_from_file(self, metrix_1, metrix_2, metrix_3):
#         net = self.read_neural_network(metrix_1, metrix_2, metrix_3)
#         self.genetic_from_file(net)
#
#     def genetic_from_file(self, brains):
#         brains_array = brains
#         np_arrays = []
